        ...
        <Link href={`/movie/${id}`} className={`group relative w-full aspect-[2/3] shrink-0 rounded-[1.25rem] overflow-hidden cursor-pointer transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 shadow-xl hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] block ${additionalClasses}`}>
            ...
            <div className="w-full h-full relative z-0">
                ...
                <div className="absolute top-3 left-3 z-20 flex flex-col gap-1.5 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-[-10px] group-hover:translate-x-0">
                    ...
                    {(matchType === 'story' || matchType === 'director') && (
                    ...
                    <div className="bg-white/10 backdrop-blur-md px-2 py-1 rounded-md border border-white/20 text-[10px] font-bold text-gray-200 shadow-lg flex items-center gap-1">
                        {genre || 'Movie'}
                    </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 w-full p-5 z-20 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300 ease-out">
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <span className="text-[11px] font-bold text-purple-400 tracking-widest uppercase">{genre || 'Movie'}</span>
                    </div>
